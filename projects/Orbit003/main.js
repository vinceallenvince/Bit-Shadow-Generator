(function() {
 ...
 'use strict';
  ...
  var generator;
  var dataFiles = null;
  var currentFrame = 744; // boss determines current frame; in devMode, we manually increment after frame is done
  ...
  function init(gen) {
    generator = gen;
    generator.addMenuItem('Orbit003', 'Orbit003', true, false);
  ...
  function menuClicked(e) {
    if (e.generatorMenuChanged.name === 'Orbit003') {
