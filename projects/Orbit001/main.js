(function() {
 ...
 'use strict';
  ...
  var generator;
  var dataFiles = null;
  var currentFrame = 50; // boss determines current frame; in devMode, we manually increment after frame is done
  ...
  function init(gen) {
    generator = gen;
    generator.addMenuItem('Orbit001', 'Orbit001', true, false);
  ...
  function menuClicked(e) {
    if (e.generatorMenuChanged.name === 'Orbit001') {
